platformGame.cDebugPanel = function (rootDomObj) {
    this.mCanvas = null;
...
platformGame.cDebugPanel.prototype.Init = function (rootDomObj) {
    //create and display canvas to write debug info to
    this.mCanvas = new platformGame.cCanvasManager();
    this.mCanvas.Init(this.mWindowWidth,this.mWindowHeight,(platformGame.gCoreManager.mDocWidth-this.mWindowWidth), 20);
...
platformGame.cDebugPanel.prototype.OnFrameChange = function (timestamp) {
    timestamp = Math.round(timestamp/1000);
    var thisObj = platformGame.gCoreManager.mDebugPanel;
    //console.debug(this.mLastTimeStamp !== timestamp)
...
platformGame.cDebugPanel.prototype.ShowDebugInfo = function () {
    var i = 1;
   ...
   // this.mCanvas.WriteFillText("FPS Count: " + this.mFPSCount, this.mLeftMargin, this.mLineHeight*++i, "#00ff00", "10px Tahoma");
    this.mCanvas.WriteFillText("Touchsreen: " + platformGame.gCoreManager.mIsTouchUI, this.mLeftMargin, this.mLineHeight*++i, "#00ff00", "10px Tahoma");
