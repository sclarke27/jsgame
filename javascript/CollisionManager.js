platformGame.cCollisionManager = function(){
    this.mMouseCir = {};
    //this.mDocWidth = 0;
    //this.mDocHeight = 0;
    this.mObjectList = [];
 ...
 * @param {Object} win
 */
platformGame.cCollisionManager.prototype.Init = function(win) {
 ...
 */
platformGame.cCollisionManager.prototype.AddActiveItem = function(control) {
 ...
 * @param {Object} control
 */
platformGame.cCollisionManager.prototype.RemoveActiveItem = function(control) {
    var totalItems = this.mActiveItems.length;
    var i = 0;
 ...
 */
platformGame.cCollisionManager.prototype.CheckActiveItems = function() {
 ...
 */
platformGame.cCollisionManager.prototype.DrawTrackingGrid = function() {
    var i = 0;
 ...
 */
platformGame.cCollisionManager.prototype.BuildEmptyItemMap = function() {
 ...
 */
platformGame.cCollisionManager.prototype.HandleMouseTracking = function(doTracking) {
    if (doTracking) {
 ...
 */
platformGame.cCollisionManager.prototype.HandleMouseMove = function() {
 ...
 * @param {Object} mouseY
 */
platformGame.cCollisionManager.prototype.FindElemsAtSegmentCoords = function(mouseX, mouseY) {
 ...
 * @param {Object} control
 */
platformGame.cCollisionManager.prototype.CheckDistance = function(mouseCircle, control) {
    var collDist = 5000;
